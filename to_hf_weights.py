####
# python to_hf_weights.py --input-ckpt gs://finetuning-6b-bucket/step_9001 --config ./configs/config-6b.json --output-path  gs://finetuning-6b-bucket/gpt-j-6B --cpu --dtype fp32
####
